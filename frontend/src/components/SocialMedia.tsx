  ...
  const socialLinks = [
    {
      name: "Facebook",
      icon: Facebook,
      href: "https://www.facebook.com/cadec.pgdav",
      bgColor: "bg-blue-600",
    ...
    },
    {
      name: "Twitter",
      icon: Twitter,
      href: "https://twitter.com/cadec_pgdav",
      bgColor: "bg-sky-500",
    ...
    },  
    {
      name: "Instagram",
      icon: Instagram,
      href: "https://www.instagram.com/cadec.pgdav",
      bgColor: "bg-pink-600",
    ...
    },
    {
      name: "LinkedIn",
      icon: Linkedin,
      href: "https://www.linkedin.com/company/cadec-pgdav/",
      bgColor: "bg-red-600",
